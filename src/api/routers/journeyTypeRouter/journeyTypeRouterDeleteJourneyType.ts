...
import {
  IJourneyTypeControllerDeleteJourneyTypeOutputError as IControllerError,
  IJourneyTypeControllerDeleteJourneyTypeOutputSuccess as IControllerSuccess,
} from '@app-ad/interfaces/api/controllers';
import { IJourneyTypeModel } from '@app-ad/interfaces/api/models/IJourneyTypeModel';

/**
 * @name					journeyTypeRouterDeleteJourneyType
 *
 * @description		The 'deleteJourneyType' router for 'journeyType', whose expected
 *                inputs have been defined within the following schema:
 *                'journeyTypeValidationSchemaDeleteJourneyType'.
 *
 ...
 *                | Server error                | 500               |
 */
export const journeyTypeRouterDeleteJourneyType = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'journeyTypeValidationSchemaDeleteJourneyType'.
      ...
      const stat = await journeyTypeController.deleteJourneyType(validatedParams);
      ...
      res
        ...
        .send({ journeyTypeId: controllerResponsePayload['journeyTypeId'] });
    } catch (error) {
      /*
