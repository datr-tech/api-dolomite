...
import {
  IHopControllerUpdateHopOutputError as IControllerError,
  IHopControllerUpdateHopOutputSuccess as IControllerSuccess,
} from '@app-ad/interfaces/api/controllers';

/**
 * @name					hopRouterUpdateHop
 *
 * @description		The 'updateHop' router for 'hop', whose expected
 *                inputs have been defined within the following schema:
 *                'hopValidationSchemaUpdateHop'.
 *
...
export const hopRouterUpdateHop = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'hopValidationSchemaUpdateHop'.
      ...
      const stat = await hopController.updateHop({ hopId, payload });
